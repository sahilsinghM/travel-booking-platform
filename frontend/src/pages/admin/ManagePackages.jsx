        ...
        <div className="space-y-2">
          ...
          <label className="block">
            <input
              ...
              className="hidden"
            />
            <div className="flex items-center justify-center px-4 py-2 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:border-ocean-blue-500 transition-colors text-sm text-gray-600 hover:text-ocean-blue-600">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
              </svg>
              Upload images from device (or click to browse)
            </div>
          </label>
        </div>
      </div>
